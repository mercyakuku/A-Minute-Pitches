...
class PitchForm(FlaskForm):
	...
	category = RadioField('Label', choices=[ ('motivationalpitch','motivationalpitch'), ('interviewpitch','interviewpitch'),('chefspitch','chefspitch'),('hairdressingpitch','hairdressingpitch')],validators=[Required()])
